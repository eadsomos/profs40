...
$texto2 = "Curso do projeto <b>PROFS</b> com carga horária de {$strcargah}, no qual obteve o aproveitamento de: {$tiranota}.";
...
if ($context) {
    ...
    if ($file) {
		...
		//$pdf->Image('http://profs.somoseducacao.com.br/mod/certificate/pix/noecxiste.png', $picx, $picy, $picw, $pich);
...
$pdf->Image('http://profs.somoseducacao.com.br/mod/certificate/pix/noecxiste.png', 10, 20, 40, 40);
