...
/**
 * Unit tests for mod_proposta lib
 *
 ...
 * @since      Moodle 3.0
 */
class mod_proposta_lib_testcase extends advanced_testcase {
     ...
     * @return void
     */
    public function test_proposta_view() {
        global $CFG;
        ...
        $moodleurl = new \moodle_url('/mod/proposta/view.php', array('id' => $cm->id));
