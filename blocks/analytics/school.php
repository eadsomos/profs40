<?php 
   ...
   foreach ($groupsid as $id) {
	...
	$escolaSelecionada = $DB->get_records_sql('SELECT DISTINCT ui.data, esco.desc_nome, esco.id
											FROM mdl_user AS u
	...
	$assID = array();
	foreach($escolaSelecionada as $escolaGrup){
...
<div id="main"> 
  ...
  <aside id="sidebar_left">
    ...
    <div class="sidebar-menu">
      <ul class="nav">
        <li> <a href=<?php echo '"school.php?userid='.$USER->id.'"'; ?> class="ajax-disable"><span class="glyphicon glyphicon-stats"></span> <span class="sidebar-title">Dados Gerais</span> <span class="sidebar-title-tray"></span> </a> </li>
        <li> <a href=<?php echo '"datatableSchool.php?userid='.$USER->id.'"'; ?> class="ajax-disable"><span class="glyphicon glyphicon-th"></span><span class="sidebar-title">Detalhamento</span></a> </li>
      </ul>
    </div>
  </aside>
    ...
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          ...
          <li class="crumb-link"><button class="btn btn-primary btn-xs" id="filtrar"> Pesquisar </button></li>
        </ol>
      </div>
			...
			$('#school').ready(function(){
             ...
             function disciplinas(){
                ...
                $.ajax({
                     ...
                     data: { function: "disciplinasSchool", userid: userid, escola:escola }
                         })
                     .done(function(data){
                        //alert(data);
                        $('#disciplinas').empty();
             ...
             function graficoDisciplinas(escola){
                ...
                $.ajax({
                     ...
                     data: { function: "graficoDisciplinasSchool", userid : userid , escola : escola}
                         })
                     .done(function(data){
                        //alert(data);
