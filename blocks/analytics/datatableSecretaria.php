...
<div id="main"> 
  ...
  <aside id="sidebar_left">
    ...
    <div class="sidebar-menu">
      <ul class="nav">
        <li> <a href=<?php echo '"secretaria.php?userid='.$USER->id.'"'; ?> class="ajax-disable"><span class="glyphicon glyphicon-stats"></span> <span class="sidebar-title">Dados Gerais</span> <span class="sidebar-title-tray"></span> </a> </li>
        <li> <a href=<?php echo '"datatableSecretaria.php?userid='.$USER->id.'"'; ?> class="ajax-disable"><span class="glyphicon glyphicon-th"></span><span class="sidebar-title">Detalhamento</span></a> </li>
      </ul>
    </div>
  </aside>
