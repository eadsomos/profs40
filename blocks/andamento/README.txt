...
* Rename the andamento/ folder to the name of your module (eg "widget").
...
all the instances of the string "andamento" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/andamento/widget/g' {} \;

* Rename the file lang/en/andamento.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_andamento.php
...
and you should find that this andamento has been added to the list of
installed modules.
