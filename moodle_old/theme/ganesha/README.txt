...
ganesha theme - Installation steps
================================

1) On your download pacakge, you will find theme_ganesha.zip

2) Unzip - theme_ganesha.zip, you will get folder 'ganesha'

3) Copy folder 'ganesha' and put into theme folder of your moodle system
...
8) By clicking "Continue" button on success page , you will get options to change the ganesha theme settings.
   You can modify the settings later too :-)


Steps to set ganesha theme as default theme for your moodle system
==================================================================
...
5) Then click "Use theme" button on "ganesha theme"
