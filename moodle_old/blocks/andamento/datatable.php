<?php 
   ...
   $nomesEscolas = $DB->get_records_sql('SELECT DISTINCT data FROM {user_info_data} WHERE userid IN ('.implode(",",$usersid).') AND fieldid = '.$_SESSION['FIELDIDS']['faculdade'],array());
  ...
  <section id="content_wrapper">
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          <li class="crumb-active">Escola <select id='school'><option value='0'>Selecione a escola</option><?php foreach ($nomesEscolas as $escola) { echo '<option value="'.$escola->data.'">'.$escola->data.'</option>';}      ?></select></li>
