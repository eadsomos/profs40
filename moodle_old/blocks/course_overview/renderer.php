...
class block_course_overview_renderer extends plugin_renderer_base {
    ...
    public function course_overview($courses, $overviews) {
        ...
        */
        ...
        $html .= html_writer::end_tag('div'); // END cat_navs    
        $html .= html_writer::end_tag('div'); // END cat_navigation
        foreach ($courses as $key => $course) {
            // If moving course, then don't show course which needs to be moved.
            if ($ismovingcourse && ($course->id == $movingcourseid)) {
                continue;
            }
            $html .= html_writer::start_tag('div', array('class' => 'all cat_'.$course->category)); // @autor Cássio Queiroz <Cruzz>
            ...
            $html .= html_writer::end_tag('div'); // hide-div
