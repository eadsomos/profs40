...
?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
			...
			function validaCodigo(){
             ...
             $('#codigo').on('keyup keypress blur change', function(){
                validaCodigo();
            });
	...
	<?php if(!$segmentodata == ''){ ?>
		<script type="text/javascript">
			$('#segmento').select2({disabled:readonly});
		</script>
	<?php } ?>

	<?php if(!$ufdata == '' || !$ufurl == ''){ ?>
		<script type="text/javascript">
			$('#estado').select2({disabled:readonly});
			$('#cidade').select2({disabled:readonly});
			$('#bairro').select2({disabled:readonly});
			$('#escola').select2({disabled:readonly});
		</script>
	<?php } ?>	
