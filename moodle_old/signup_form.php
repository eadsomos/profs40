<?php
    ...
    $cursos = $DB->get_records_sql('SELECT DISTINCT * 
									FROM {course} 
									INNER JOIN {enrol} ON {course}.id = {enrol}.courseid 
									WHERE {enrol}.id NOT IN ('.implode(",",$return).')
									GROUP BY mdl_course.shortname 
									ORDER BY mdl_course.shortname', array());
			...
			<div class="container">
				...
				<div class="row-fluid">
					<div class="span6">
                		...
                		<input type="text" name="email" class="form-control" id="email" <?php if(!$email == ''){echo 'readonly';} ?> value="<?php echo $email; ?>" >
					</div>
					<div class="span6">
				...
				<div class="row-fluid">
					...
					<div class="span4">
						<div class="ui-widget">
							...
							<select class="form-control" id="bairro" name="bairro" style="height:40px!important;width:100%; ">
								<?php if($hasEntry){ 
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="ui-widget">
							...
							<select class="form-control" id="escola" name="escola" style="height:40px!important;width:100%; ">
								<?php if($hasEntry){ 
