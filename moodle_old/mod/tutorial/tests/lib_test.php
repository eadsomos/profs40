...
/**
 * Unit tests for mod_tutorial lib
 *
 ...
 * @since      Moodle 3.0
 */
class mod_tutorial_lib_testcase extends advanced_testcase {
     ...
     * @return void
     */
    public function test_tutorial_view() {
        global $CFG;
        ...
        $moodleurl = new \moodle_url('/mod/tutorial/view.php', array('id' => $cm->id));
