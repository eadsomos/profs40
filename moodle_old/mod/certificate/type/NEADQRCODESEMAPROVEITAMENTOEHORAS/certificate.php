...
if ($escolaAtual == "CENTRO UNIVERSITARIO ITALO BRASILEIRO - UNIITALO"){
	$strtexto =  "A Somos Educação certifica que <b>{$strname}</b>, aluno(a) no(a) {$escolaAtual}, portador do CPF {$cpfcursista}, concluiu o curso <b>{$strcurso}</b> realizado de <b>{$comecoCurso}</b> a <b>{$strdata}</b>.";
}else{
	$strtexto =  "A Somos Educação certifica que <b>{$strname}</b>, professor(a) no(a) {$escolaAtual}, portador do CPF {$cpfcursista}, concluiu o curso <b>{$strcurso}</b> realizado de <b>{$comecoCurso}</b> a <b>{$strdata}</b>.";
}
