...
class mod_assign_renderer extends plugin_renderer_base {
    ...
    public function render_assign_submission_plugin_submission(assign_submission_plugin_submission $submissionplugin) {
        global $DB;
        $o = '';
        $uservimeo = $DB->get_record('user',array('id'=>$submissionplugin->submission->userid));                                            
        $embed = $DB->get_record('assign_vimeo', array('assign'=>$submissionplugin->submission->assignment,'author'=>$uservimeo->username));
        ...
        if ($submissionplugin->view == assign_submission_plugin_submission::SUMMARY) {
            ...
            if($embed){
                $o .= $link;
                $o.= '<tr class=""><td class="cell c0" style="">Envio do aluno</td>
                <td class="cell c1 lastcol" style=""><div class="box boxaligncenter plugincontentsummary summary_assignsubmission_file_53"><div id="assign_files_tree57c5efa4d15a73"><div class="ygtvitem" id="ygtv0"><div class="ygtvchildren" id="ygtvc0"><div class="ygtvitem" id="ygtv1"><table id="ygtvtableel1" border="0" cellpadding="0" cellspacing="0" class="ygtvtable ygtvdepth0 ygtv-expanded ygtv-highlight0"><tbody><tr class="ygtvrow"><td id="ygtvt1" class="ygtvcell ygtvln"><a href="#" class="ygtvspacer">&nbsp;</a></td><td id="ygtvcontentel1" class="ygtvcell ygtvhtml ygtvcontent"><div>'.$embed->embed.'</div></td></tr></tbody></table><div class="ygtvchildren" id="ygtvc1" style="display:none;"></div></div></div></div></div></div></td>
                </tr>';
            }else{
                $o .= $link . $summary;
            }
