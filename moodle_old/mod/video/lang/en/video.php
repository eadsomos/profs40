...
$string['modulename_help'] = 'The video module enables a teacher to create a web video resource using the text editor. A video can display text, images, sound, video, web links and embedded code, such as Google maps.

Advantages of using the video module rather than the file module include the resource being more accessible (for example to users of mobile devices) and easier to update.

For large amounts of content, it\'s recommended that a book is used rather than a video.
