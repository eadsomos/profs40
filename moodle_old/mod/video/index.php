...
$video->set_url('/mod/video/index.php', array('id' => $course->id));
$video->set_title($course->shortname.': '.$strvideos);
$video->set_heading($course->fullname);
$video->navbar->add($strvideos);
echo $OUTPUT->header();
