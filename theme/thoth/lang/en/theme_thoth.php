...
$string['choosereadme'] = 'Theme thoth is a child theme of Boost. It adds the ability to upload background thoth.';
// Name of the settings pages.
$string['configtitle'] = 'thoth settings';
